...
https://batradzsanakoev.github.io/mesto-react

---
Проектная домашняя работа по Яндекс Практикуму. Представляет из себя одностраничный сайт с использованием фреймворка React. Состоит несколькими основными блоками с применением навыков адаптивной верстки и написания скриптов.
---
В данном проекте задействованы(на данный момент) следующие технологии:
* использование технологии React;
* медиа-запросы;
